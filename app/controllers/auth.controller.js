        ...
        .then((users) => {
            ...
            UserClaim.findAll({
                ...
                for (let k = 0; k < userClaim.length; k++) {
                    let type =
                        userClaim[k].dataValues.permissionClaim.dataValues.type;
                    let claimsArray = [];
                    for (let l = 0; l < userClaim.length; l++) {
                        if (userClaim[l] !== undefined) {
                            if (
                                type ===
                                userClaim[l].dataValues.permissionClaim
                                    .dataValues.type
                            ) {
                                let claim =
                                    userClaim[l].dataValues.permissionClaim
            ...
            RoleClaim.findAll({
                ...
                for (let i = 0; i < roleClaim.length; i++) {
                    ...
                    let valueOfType =
                        roleClaim[
                            i
                        ].dataValues.permissionClaim.dataValues.value.toString();
                    ...
                    if (
                        ...
                        if (roleClaim[i] !== undefined) {
                            if (
                                type ===
                                roleClaim[i].dataValues.permissionClaim
                                    .dataValues.type
                            ) {
                                let claim =
                                    roleClaim[i].dataValues.permissionClaim
